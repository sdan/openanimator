...
`
  ...
  return `Output external video link in mp4 to render in markdown. https://runitupturbo-production.up.railway.app/get_video/${vid_id}. <video src="https://runitupturbo-production.up.railway.app/get_video/${vid_id}" type="video/mp4"></video>'`;
}
